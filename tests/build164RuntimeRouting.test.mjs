...
test("Build 164 metadata extension handlers are real Tauri commands", () => {
...
test("Build 164 restored providers remain normalized and listed by extension source", () => {
  const metadataExt = source("src-tauri/src/metadata_ext.rs");
...
test("Build 164 metadata provider responses do not echo raw upstream payloads over IPC", () => {
  const metadataExt = source("src-tauri/src/metadata_ext.rs");
