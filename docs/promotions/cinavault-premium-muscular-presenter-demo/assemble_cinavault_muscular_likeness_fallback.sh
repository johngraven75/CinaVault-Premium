...
OUT="$ROOT/cinavault-premium-muscular-likeness-presenter-demo.mp4"
FONT=/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf
PRESENTER="$ROOT/cinavault-user-likeness-muscular-presenter-reference.png"
mkdir -p "$OUTDIR"
...
sha256sum "$OUT" > "$ROOT/cinavault-premium-muscular-likeness-presenter-demo-sha256.txt"
echo "$OUT"
