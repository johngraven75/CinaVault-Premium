...
const requiredLegacyCapabilities = [
  ...
  ['Metadata extensions', 'src-tauri/src/metadata_ext.rs', ['get_metadata_providers', 'metadata_ext']],
  ['PGMA bridge', 'src-tauri/src/pgma_bridge.rs', ['refresh_pgma_library', 'find_local_candidates', 'pgma_bridge']],
  ['Adult provider', 'src-tauri/src/adult_site_provider.rs', ['porn_site_nuxt_entries', 'adult_site_provider']],
  ['AI media agent', 'src/services/aiMediaAgent.ts', ['buildMediaAgentTask', 'aiMediaAgent']],
  ['CinaVault server', 'src/services/serverProvider.ts', ['getPreferredMediaServer', 'cinavaultServer']],
  ['AI fallback', 'src/services/aiProviderFallback.ts', ['getSafeAiProvider', 'aiProviderFallback']],
