// CinaVault Premium — Tauri v2 Rust Backend (Build 130)
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            log::info!("CinaVault Premium Build 130 initialized successfully");
            Ok(())
        })
...
fn get_app_info() -> serde_json::Value {
    serde_json::json!({
        ...
        "version": "1.0.0-18",
        "build_tag": "Build 130 Server Startup Hygiene + Remote Connect Guide Android APK (Premium Edition)",
