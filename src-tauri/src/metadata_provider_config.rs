...
pub fn default_registry() -> MetadataProviderRegistry {
    MetadataProviderRegistry {
        ...
        providers: vec![
            provider("tmdb", "TMDb", "Movies & TV", true, true, Some("https://api.themoviedb.org/3")),
            provider("omdb", "OMDb", "Movies & TV", true, true, Some("https://www.omdbapi.com")),
            provider("tvdb", "TVDB", "Movies & TV", true, false, Some("https://api4.thetvdb.com/v4")),
            provider("trakt", "Trakt", "Movies & TV", true, false, Some("https://api.trakt.tv")),
            provider("imdb", "IMDb", "Movies & TV", false, false, Some("https://www.imdb.com")),
            provider("rotten_tomatoes", "Rotten Tomatoes", "Movies & TV", false, false, Some("https://www.rottentomatoes.com")),
            provider("cinemeta", "CINEMETA", "Movies & TV", false, true, Some("https://v3-cinemeta.strem.io")),
            provider("tvmaze", "TVMaze", "Movies & TV", false, true, Some("https://api.tvmaze.com")),
            provider("musicbrainz", "MusicBrainz", "Music", false, true, Some("https://musicbrainz.org/ws/2")),
            provider("audiodb", "AudioDB", "Music", true, false, Some("https://theaudiodb.com/api/v1/json")),
            provider("lastfm", "Last.fm", "Music", true, false, Some("https://ws.audioscrobbler.com/2.0")),
            provider("discogs", "Discogs", "Music", true, false, Some("https://api.discogs.com")),
            provider("anidb", "AniDB", "Anime", true, false, Some("https://api.anidb.net:9001/httpapi")),
            provider("anilist", "AniList", "Anime", false, false, Some("https://graphql.anilist.co")),
            provider("myanimelist", "MyAnimeList", "Anime", true, false, Some("https://api.myanimelist.net/v2")),
            provider("kitsu", "Kitsu", "Anime", false, false, Some("https://kitsu.io/api/edge")),
            provider("fanarttv", "Fanart.tv", "Artwork", true, false, Some("https://webservice.fanart.tv/v3")),
            provider("tmdb_images", "TheMovieDB Images", "Artwork", true, true, Some("https://image.tmdb.org/t/p")),
            provider("pgma", "PGMA Modernized", "Adult", false, true, Some("cinavault://pgma-bridge")),
            provider("porn_site_nuxt", "Porn Site Nuxt", "Adult", false, true, None),
            provider("tpdb", "ThePornDB", "Adult", true, true, Some("https://api.theporndb.net")),
            provider("stashdb", "StashDB", "Adult", true, true, Some("https://stashdb.org/graphql")),
            provider("phoenixadult", "PhoenixAdult", "Adult", false, true, None),
            provider("iafd", "IAFD", "Adult", false, false, Some("https://www.iafd.com")),
            provider("opensubtitles", "OpenSubtitles", "Subtitles", true, false, Some("https://api.opensubtitles.com/api/v1")),
            provider("subscene", "Subscene", "Subtitles", false, false, Some("https://subscene.com")),
            provider("igdb", "IGDB", "Other", true, false, Some("https://api.igdb.com/v4")),
            provider("openlibrary", "OpenLibrary", "Other", false, false, Some("https://openlibrary.org")),
            provider("goodreads", "GoodReads", "Other", true, false, Some("https://www.goodreads.com")),
            provider("epg_guide", "EPG Guide", "Other", false, false, None),
            provider("plex_agents", "MS-A Agents", "Agents", false, false, None),
            provider("emby_providers", "MS-B Providers", "Agents", false, false, None),
            provider("jellyfin_providers", "MS-C Providers", "Agents", false, false, None),
        ],
    }
}

fn merge_existing(mut defaults: MetadataProviderRegistry, current: Option<MetadataProviderRegistry>) -> MetadataProviderRegistry {
