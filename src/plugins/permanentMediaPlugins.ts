...
export const permanentMediaPlugins: PermanentPlugin[] = [
  {
    ...
    name: "FFmpeg",
    version: "6.x",
    description: "Industry-standard multimedia framework. Powers all transcoding, thumbnail generation, chapter extraction, and format conversion.",
  ...
  },
  {
    ...
    name: "FFprobe",
    version: "6.x",
    description: "Media analysis companion to FFmpeg. Extracts codec, resolution, duration, and embedded metadata from all media files.",
    category: "analysis",
    executable: "ffprobe",
  ...
  },
  {
    ...
    name: "yt-dlp",
    version: "latest",
    description: "Premier video downloader supporting 1,000+ sites. Powers all download operations including YouTube, Vimeo, and streaming platforms.",
    category: "download",
    executable: "yt-dlp",
  ...
  },
  {
    ...
    name: "MediaInfo",
    version: "latest",
    description: "Detailed technical and tag information about video and audio files. Used for deep media analysis and library quality checks.",
    category: "analysis",
  ...
  },
  {
    ...
    name: "MKVToolNix",
    version: "latest",
    description: "Tools for creating, editing, and inspecting Matroska (MKV) files. Used for subtitle and chapter manipulation.",
    category: "transcoding",
    executable: "mkvmerge",
...
export function arePermanentMediaPluginsReady(): boolean {
  return permanentMediaPlugins.length > 0 && permanentMediaPlugins.every((p) => p.enabled);
}
...
export function getPluginsByCategory(category: PermanentPlugin["category"]): PermanentPlugin[] {
