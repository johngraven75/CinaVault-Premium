...
export const THEME_PRESETS: ThemePreset[] = [
  {
    ...
    name: "Prism Fusion",
    colors: {
      bg: "#080b18", panel: "rgba(16,20,42,0.82)", "panel-2": "rgba(22,28,58,0.74)",
      "panel-3": "rgba(28,34,72,0.66)", text: "#f6f7ff", subtext: "#b9bfd8",
      accent: "#00c2ff", "accent-2": "#ff4fd8", "accent-3": "#ffa141",
      gold: "#ffd166", "row-a": "rgba(14,22,52,0.62)", "row-b": "rgba(22,30,64,0.62)",
      danger: "#ff5d73", "neon-1": "#66f3ff", "neon-2": "#b88cff", "neon-3": "#ff8a5b",
    },
  },
  {
    id: "emby_sdk",
